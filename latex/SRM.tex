...
This paper analyses quantitative techniques for the choice of the hedge ratio of the CC portfolios with various copulae and risk measures. \medskip
...
Significant tail risks lead to the need to investigate even static hedges with more refined methods than minimum-variance based \citep{ederington2008minimum}. \medskip
...
We consider also Value-at-Risk (VaR), Expected Shortfall (ES), and Spectral Risk Measures (SRM).
