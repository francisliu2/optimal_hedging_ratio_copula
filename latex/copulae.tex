...
In particular, we are interested in the radially symmetric among other symmetry definitions, see \ref{Nelsen1999}.
...
\begin{figure}[t]
  ...
  \caption{Scatter plot of samples drawn from copulae. All copulas are calibrated to Spearman's $\rho$ of 0.75.}\label{fig:copulaeScatterPlot}
\end{figure}
