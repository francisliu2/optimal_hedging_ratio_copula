...
In the empirical analysis, we consider \natp{the capability (was: the
  risk reduction capability)} 
of CME Bitcoin Futures (BTCF) \natp{to reduce the risk of (was: on)}
...
\natp{\em [What is the whole time frame?]}
...
throughout the whole result section.  \natp{\em [Either mention the
  time range of the in-sample data or mention the whole data range
  above, where it is specified that the data are from 15.00 each day,
  etc.]} 
...
\begin{table}[t]
    \centering
      ...
      \end{tabularx}
        ...
        \url{https://bloom.bg/3cWdita}.} \natp{\em [Table 2 is not
        referenced in the text. Please fix.]}
        \label{tab:All_min}
  \end{table}
%\clearpage
