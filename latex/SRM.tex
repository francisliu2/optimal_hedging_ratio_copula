...
CCs and their derivatives into their portfolii, 
...
Financial data is known to be non Gaussian \natp{\cite{Cont2001}}, let
...
Unlike dependence measures, such as the correlation coefficient, Kendall's tau, and Spearman's rho,
copulae \natp{capture (was: describe)} the whole dependence structure of random
variables. 
