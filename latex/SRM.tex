...
The approach is therefore generalised to various risk measures, such as Value-at-Risk, Expected Shortfall and a variety of Spectral Risk Measures.
...
Our findings are based on an analysis for the time span from 15/12/2017 to 04/02/2021.
The results allows investors to construct a stable portfolio with digital assets.
\\
...
Trading volume in BTC futures surpassed \$2 trillion in 2020 (CryptoCompare, 2020).
...
The price of bitcoin even surged to USD 20,000 at beginning of 2021.
...
, later popularised by the work of Abe Sklar \citep{Sklar1959}.
