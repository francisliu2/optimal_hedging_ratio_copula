...
\title{\bigskip\bigskip\bigskip\\
  \bfseries{Hedging Cryptos with Futures}}
...
\note{%
  ...
  \item Mixture: df is linear combination of Gaussian and product
    copulas
  \item NIG factor: Random variables are linear combination of joint
    factor and idiosyncratic component (again NIG under certain
    condition)
  \item Plackett: bivariate only; derived from the condition on a
    constant odds ratio for all values that bivariate continuous df
    can take.
  \item Which ones have tail dependence? Student-$t$, Clayton (one
    tail only), Gumbel (one tail only) (not: Gaussian, NIG factor,
    mixture, Plackett, Frank) 
  \end{itemize}
}
...
%   \frametitle{Time series}
  ...
  %   \includegraphics[scale=.6]{../_pics/btc_hist.pdf}
  % \end{minipage}
  % \begin{minipage}[t]{.5\linewidth}
  %   \begin{itemize}
  %   \item Student $t$ distribution: $\nu=7.95$
  %   \item Generalised Pareto distribution (EVT): tail index
  %     $1/\xi=4.92$
  %   \end{itemize}
  % \end{minipage}
...
\begin{frame}
  ...
  \begin{center}
    \begin{overprint}
      ...
      %\includegraphics<3>[scale=.8]{../_pics/PL_dyn_series_Gumbel.pdf}
  ...
  \item Recalibration every 5 days\hfill
    \hyperlink{dynamic}{\beamergotobutton{Other copulas}}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vspace*{-\baselineskip}
  \begin{center}
    \includegraphics[scale=.5]{../_pics/rrmse_dynamic.pdf}
  \end{center}
  \begin{itemize}
  \item RMSE (compared to zero) relative to RMSE of unhedged position
  \item 99\% risk measures underperform
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vspace*{-\baselineskip}
  \begin{center}
    \includegraphics[scale=.5]{../_pics/rdsv_dynamic.pdf}
  \end{center}
  \begin{itemize}
  \item Downside semi-variance relative to downside
    semi-variance of unhedged position
  \item VaR 95\% and SRM perform best
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vspace*{-\baselineskip}
  \begin{center}
    \includegraphics[scale=.55]{../_pics/rrmse_static.pdf}
  \end{center}
  \begin{itemize}
  \item RMSE (compared to one) relative to RMSE of unhedged position
  \item Gumbel with ES 95\% or SRM performs best
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vspace*{-\baselineskip}
  \begin{center}
    \includegraphics[scale=.55]{../_pics/rdsv_static.pdf}
  \end{center}
  \begin{itemize}
  \item Downside semi-variance relative to downside semi-variance of
    unhedged position 
  \item SRM performs best, together with VaR 95\%
  \end{itemize}
\end{frame}
