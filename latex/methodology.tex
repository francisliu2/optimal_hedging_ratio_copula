...
\item \textbf{Determine OHR}.
  ...
  \item \textbf{Obtain testing log-return of hedged
      portfolio}. \natp{\em [``testing log-return'' is a bit
      confusing. I think ``testing'' refers to test data set? Find
      better formulation.]} 
