...
On the other hand, our results support treating cryptos with a matured regulated derivatives market seperately from those without. 
...
On the one hand, BTC price movements can be effectively offseted by BTC futures.
On the other hand, in some extreme cases like ADA and XRP, hedging effectiveness is negative, meaning adding BTC futures failed to reduce and may amplify the risk. 
Further studies are required to generalise 

A general case 

the existence of derivative that solely references the cryptoasset empowers market participants to hedge their corresponding crypto position,
...
intraday data or if there are significant differences. Contrary to the
setting with with daily data, this requires that we use data from
