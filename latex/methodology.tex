...
\citepar{Nelsen1999} as follows. \natp{\em [Please check. I get an
  error that \citepar{} is not known.]}
...
\item \textbf{Calibrate copulae}:
  ...
  method of moments described in Section
  \ref{subsec:simulated-method-of-moments}. \natp{\em [References do
    not work.]}
...
\item \textbf{Determine optimal hedge ratio}:
  ...
  The minimisation algorithm \textit{scipy.optimize.minimize} from the
  Python package {\em Scipy} \citep{2020SciPy-NMeth} is used for the
  search of optimal hedge ratio.
\end{enumerate}
...
We present the re-parametrised \natp{\em [What does re-parameterised mean?]} version of NIG factor copula in this section.
...
\natp{\em [Please be consistent in using Spearman's rho.]}
