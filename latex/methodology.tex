...
\begin{proposition}
  ...
  \end{equation}
\end{proposition}
Here $F^{(-1)}$ denotes the inverse of $F$, i.e. the quantile function.
  ...
  \begin{align*}
    F_{Z}(z) &= \p(X - h Y\leq z) %
               ...
               = 1- \int_0^1 D_1 C_{X, Y}\left[u,
                 ...
                 z}{h}\right\}\right]\, d u.
  \end{align*}
 The relationship $D_1 C(u,v)=\p(Y\leq y|X=x)$ is easily shown to fulfil. See e.g.\ equation (5.15)
from \citet{McNeil2005}:
