Bitcoin reference rate and Bitcoin future data from 28/02/2018 to 03/02/2021.
Data 
- only include trading days
- from Bloomberg Terminal dated with Berlin Time. 
- sliced into train set with length of 300 and test set with length of 30. 
- step size is 30, so no testing data is repeated
- in each set, testing data is the 30 trading days consecutive to the last training data
