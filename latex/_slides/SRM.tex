...
\note{%
  ...
  \item Factor NIG: Random variables are linear combination of joint
    ...
    condition)
  \item Plackett
  \item Which ones are heavy-tailed? Student-$t$ (not: Gaussian, NIG
    factor, Mixture)
  \item Which ones have tail dependence? Student-$t$ (not: Gaussian)
  \end{itemize}
}
...
\note{%
  \begin{itemize}
  \item Lower panel can be more-or-less thought of as hedge with $h=1$
  \end{itemize}
}
...
\note{%
  \begin{itemize}
  \item Francis: Do we use MLE as well?
