...
We also indicate the dates when the five smallest returns occur in the spot return. \medskip
...
Most of the time different risk reduction objectives generate very similar hedged portfolio returns as one can from the plot that the hedged portfolio returns are overlapping to each other.
