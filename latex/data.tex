...
Figure~\ref{fig:BTC_price} presents the BTC and BTCF price in the first panel and the arithmetic difference between the daily return of BTC and BTCF $R_s - R_f$ in the
second panel.
