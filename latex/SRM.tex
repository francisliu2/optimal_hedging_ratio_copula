...
Hedge ratio is the appropriate size of futures contracts which should be held in order to cancel the movements of BTC price.
...
The risk estimation is directly related to individual's utility function.
