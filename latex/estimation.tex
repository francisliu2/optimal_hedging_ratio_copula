...
\subsubsection{Simulated Method of Moments}\label{subsec:simulated-method-of-moments}
...
We denote by $\tilde{\bm{m}}(\bm{\theta})$ the $m$-dimensional vector of dependence measures according the the
...
\begin{align*}
    ...
    \hat{\bm{W}}
     \bm{g}(\bm{\theta}),
\end{align*}
where $\hat{W}$ is some positive definite weight matrix.\medskip
...
However, the IFM requires making assumption on the distribution of the margins.
