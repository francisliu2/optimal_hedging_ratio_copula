...
$\phi$ (see below).
We reduce one risk measure at a time and we call the risk measure being used risk reduction objective.
Different combinations of copula and risk reduction objective are studied in this work.
...
In addition to \cite{Barbi2014} we propose an expression for the density of $R^h$
