...
We standardise NIG distribution to mean zero and unit variance. 
Reparameterisation follows by the standarisation: 
$\delta(\alpha, \beta) = \frac{(\alpha^2-\beta^2)^\frac{3}{2}}{\alpha^2}$ and 
$\mu(\alpha, \beta)    = -\frac{\beta^3}{\alpha^2}-\beta$.



 $X \overset{\text{def}}= G^{(-1)}(u; \alpha, \beta, \mu, \delta + \delta_X)$ and 
 $Y \overset{\text{def}}= G^{(-1)}(v; \alpha, \beta, \mu, \delta + \delta_Y)$. 
