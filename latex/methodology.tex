...
(fix delta1 and delta2 but let the delta from Z free; everything is standardised for copula)
...
\begin{enumerate}
  ...
  \item Set $\delta = \frac{(\alpha^2-\beta^2)^{3/2}}{\alpha^2}$ such that $Z$ is unit variance.  
  \item Set $\delta_1 = \delta_2$; Define $\tilde \delta = \delta_1 = \delta_2$. 
