...
Figure~\ref{fig:index_price} and \ref{fig:individualCoins_price} are the cumulative returns of the indices and individual cryptos respectively.
The black vertical lines labeled by assets name are the largest daily price drop of the assets i the out-of-sample data. \medskip
...
\includegraphics[width=\textwidth]{_pics/BTC_price.pdf}
  ...
  The crosses locate the level the difference.
