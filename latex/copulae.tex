...
An overview of copulae can be found in \citet{hardle2008applied}.
...
%and product copula $\bm{\Pi}=uv$ are three important special instants of copulae.
...
The Archimedean copulae forms a large class of copulae with many convenient features.\medskip
