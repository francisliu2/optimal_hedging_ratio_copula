...
\textit{AIC selection results}: From table \ref{tab:copulasection_intraday},
we can see the AIC procedure favours the same set of copulae in the intraday setting for both BTC-BTCF and ETH0BTCF portfolios.
