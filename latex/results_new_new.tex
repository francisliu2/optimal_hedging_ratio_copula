...
%   assets.]} 
On the other hand, the symmetry of the $t$-copula appears to be 
...
the BTCF: asset prices tend to crash simultaneously whereas positive development
...
In order to obtain a robust HE result, we apply the bootstrapping method.
...
% We choose $p=1/300$, implying the average block length is 300.
% The average length of 300 is chosen to be aligned with the length of each training set.  
...
This is, of course, counter-productive to hedging indicating
  that BTC futures may not be suitable for cross-asset hedges 
