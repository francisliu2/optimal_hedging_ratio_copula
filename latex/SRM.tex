...
\natp{\em [Why ``in addition''? They have a density expression as
  well. Be very careful with Barbi / Romagnoli -- since the paper is
  so prominent here, chances are high that one of them will be asked
  to referee.]}
...
\natp{\em [Are we going to use this anywhere?]}
